<?php /* C:\xampp\htdocs\jadwalPertandingan\private\resources\views/pages/index.blade.php */ ?>
			...
			<div class="card-header">LOGIN ADMIN</div>
				<div class="card-body">
					<form>
						...
						<a class="btn btn-primary btn-block" href="halamanadmin.blade.php">Login</a>
					</form>
